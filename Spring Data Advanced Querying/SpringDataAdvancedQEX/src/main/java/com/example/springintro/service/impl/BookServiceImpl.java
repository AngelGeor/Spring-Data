...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public List<Book> findAllByEditionTypeAndCopiesLessThan(EditionType type, Integer numberOfCopies) {
        return this.bookRepository.findAllByEditionTypeAndCopiesLessThan(type,numberOfCopies);
    }

    @Override
    public List<Book> findAllWithPriceLessThanOrPriceGreaterThan(float lowerBound, float upperBound) {
   BigDecimal lower = BigDecimal.valueOf(lowerBound);
   BigDecimal higher = BigDecimal.valueOf(upperBound);
    ...
    public List<Book> findNotReleasedIn(int releaseYear) {
        ...
        return this.bookRepository.releaseDateBeforeOrReleaseDateAfter(before,after);
    }
